...
\textbf{PLEASE EXPLAIN AVERAGE RATING RELATED OBSERVATIONS HERE}
...
\section{Text Mining}
\input{reg_ind_withtext_simplified}
\input{reg_mkt_textbased_simplified}
...
\begin{align}
    \text{Installer\_Activity}_{i,m,t+1}=\beta_{0}+\delta pro_{i,t}+\beta_{1}\text{Rating\_Entropy\_Self}_{i,t}+\beta_{2}\\ \nonumber
    \text{Rating\_Entropy\_Self}_{i,t}^ {2}+\beta_{3} \text{Rating\_Entropy\_Others}_{i,t}+\beta_{4}\text{Rating\_Entropy\_Others}_{i,t}^{2}+ \text{Controls}_{i,m,t}+ \alpha_{i} + \epsilon_{i,t+1}
\end{align}
