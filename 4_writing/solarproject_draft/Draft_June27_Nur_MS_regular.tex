...
\begin{document}
	...
	\TITLE{Do Noisy Customer Reviews Discourage Platform Sellers? Empirical and Textual Analysis of an Online Solar Marketplace Using Deep Learning}
...
\vspace{-10pt}
\ECHead{Electronic Companion for ``Do Noisy Customer Reviews Discourage Platform Sellers? Empirical and Textual Analysis of an Online Solar Marketplace Using Deep Learning''}
%\begin{APPENDICES}
% \label{vif_ind}
%\input{vif_ind.tex}
