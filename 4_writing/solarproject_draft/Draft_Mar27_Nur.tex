...
\RUNTITLE{Do Noisy Customer Reviews Discourage Online Platform Sellers? An Analysis of a Solar Installation Marketplace}
%INhibitator, Impede, Hinder, Inpe
% Full title. Sample:
% \TITLE{Bundling Information Goods of Decreasing Value}
% Enter the full title:
\TITLE{Do Noisy Customer Reviews Discourage Online Platform Sellers? An Analysis of a Solar Installation Marketplace}
...
%Online marketplaces are transforming numerous sectors. In 2019, globally, gross merchandise sales of top online marketplaces grew 22\%, and exceeded the astonishing \$2 trillion dollars milestone \citep{onlinemarket}.
...
\input{subsection_rob_spline.tex}
