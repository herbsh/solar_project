...
\noindent \textbf{Academic/Practical Relevance:}  To our knowledge, this is the first paper that empirically studies how the review dispersion affects a seller's activity level and the number of matches in an online marketplace with active sellers. Distinct from literature, our paper examines the relationship between the review dispersion and \emph{supply-side activities} of an online service marketplace.
